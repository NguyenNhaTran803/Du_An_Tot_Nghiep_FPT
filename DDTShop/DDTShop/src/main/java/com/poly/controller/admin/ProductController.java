...
public class ProductController {
	...
	@ModelAttribute(value = "color")
	public List<Color> color() {
		return colorService.findAll();
	}
	
	@ModelAttribute(value = "size")
	...
	public String saveOrUpdateId(Model model, @RequestParam(value = "id") Long id) {
		...
		product.setBanner(product.getBanner());
	...
	public String saveOrUpdate(Model model, @Valid @ModelAttribute("productDto") ProductDto productDto,
		...
		Color color = colorService.findById(productDto.getColorId()).get();
		Size size = sizeService.findById(productDto.getSizeId()).get();
		Product product;
