...
public class BrandController {
	...
	public ResponseEntity<Brand> deleteApi(@PathVariable(name = "id") Long id) throws IOException {
		// Kiểm tra xem có sản phẩm nào liên quan đến category không
		Optional<Brand> brand = brandService.findById(id);
		if (brandService.hasProducts(id)) {
			return new ResponseEntity<Brand>(brand.get(), HttpStatus.BAD_REQUEST);
		}
